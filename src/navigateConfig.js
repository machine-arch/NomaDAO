...
} from './components/booking/EventHandlers/BookingEventHandlers';
import { handleDate } from './components/booking/EventHandlers/BookingEventHandlers';
import { handlePersons } from './components/booking/EventHandlers/BookingEventHandlers';
import { handleLocation } from './components/booking/EventHandlers/BookingEventHandlers';
          ...
          description__container: {
            ...
            components: {
              description__container: {
                id: '1',
                isActive: false,
                activeClass: 'booking-description__container-active-element',
          ...
          booking__detailed__rooms: {
            ...
            components: {
              detailed__search__check: {
                id: '1',
                isActive: false,
                activeClass: 'booking-detailed__search__check-active-element',
                className: 'detailed__search__check',
              },
              detailed__search__guests: {
                id: '2',
                isActive: false,
                activeClass: 'booking-detailed__search__guests-active-element',
                className: 'detailed__search__guests',
              },
              availability__btn: {
                id: '3',
                isActive: false,
                activeClass: 'booking-availability__btn-active-element',
